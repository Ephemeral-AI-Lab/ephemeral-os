...
- Run id: `squash-20260703-090930`
- Generated: `2026-07-03T09:09:54+08:00`
- Pytest exit status: `atexit`
- Cases: `11` run · `10` pass · `0` slow · `1` fail · `0` skipped
...
| `SMK-05` | smoke | FAIL | fail:  | fail:  | fail:  |  |
...
| --- | ---: | ---: | ---: | ---: |
| `T_e2e` | 11 | 1283.954 | 2070.441 | 2575.561 |
| `T_quiesce` | 2 | 0.000 | 0.000 | 0.000 |
| `T_remount` | 2 | 1.000 | 1.000 | 1.000 |
| `T_squash` | 9 | 34.032 | 37.873 | 39.027 |
| `T_squash_invocation_1` | 8 | 33.519 | 38.018 | 39.027 |
| `T_squash_invocation_2` | 4 | 30.666 | 34.126 | 34.463 |
| `T_squash_invocation_3` | 1 | 29.130 | 29.130 | 29.130 |
