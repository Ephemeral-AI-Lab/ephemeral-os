...
import { Conversation, type ConversationRecord } from "../src/conversation.js";
import { RunHandle, type AgentEvent } from "../src/run-handle.js";
import type {
  ToolBatchContext,
  ToolExecutor,
  ToolUseBlock,
...
export function startLoop(options: {
  ...
  const handle = new RunHandle<string>({
