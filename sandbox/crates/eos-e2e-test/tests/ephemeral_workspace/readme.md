...
- [ ] ephemeral_workspace-route-edges: Multi-path shell capture, command/publish timing fields, and read-intent no-publish behavior stay observable through daemon responses and metrics.
