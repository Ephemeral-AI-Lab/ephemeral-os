...
pub(super) type CallbackHandler =
    Arc<dyn Fn(PpcMessage) -> Result<PpcMessage, PpcError> + Send + Sync>;
pub(super) type PpcResult = Result<PpcMessage, PpcError>;
...
impl PendingCalls {
    ...
    pub(super) fn complete_reply(&self, message: PpcMessage) {
        ...
        // message. Drop it: failing the whole pending set here would cascade-fail
    ...
    pub(super) fn callback_handler_for_message(
        &self,
        message: &PpcMessage,
