...
use eos_operation::{FaultDetails, OpError, OperationEnvelope, OperationFault, ResponseMeta};
use serde::Serialize;
...
fn error_kind_wire_name(kind: ErrorKind) -> &'static str {
    match kind {
        ...
        ErrorKind::ForbiddenInIsolatedWorkspace => "forbidden_in_isolated_workspace",
        ErrorKind::LifecycleInProgress => "lifecycle_in_progress",
    }
}
