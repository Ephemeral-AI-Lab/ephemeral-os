...
pub(crate) fn op_enter(args: &Value, context: DispatchContext<'_>) -> Result<Value, DaemonError> {
    crate::services::workspace_run::isolated::op_enter(args, context)
}

pub(crate) fn op_exit(args: &Value, context: DispatchContext<'_>) -> Result<Value, DaemonError> {
    crate::services::workspace_run::isolated::op_exit(args, context)
}

pub(crate) fn op_status(args: &Value, context: DispatchContext<'_>) -> Result<Value, DaemonError> {
    crate::services::workspace_run::isolated::op_status(args, context)
}
...
pub(crate) fn op_list_open(
    ...
    crate::services::workspace_run::isolated::op_list_open(args, context)
}
...
pub(crate) fn op_test_reset(
    ...
    crate::services::workspace_run::isolated::op_test_reset(args, context)
}
