...
//! the runner child, reaping it into a policy-free [`process::ReapedCommand`],
...
//! and what happens to the upperdir at settle, is the command-ops tier's
//! concern. The mode string a settled response carries is opaque here.
//!
