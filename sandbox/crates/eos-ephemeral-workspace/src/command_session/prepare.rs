...
use crate::{EphemeralDirAllocator, InvocationId};
    ...
    P: EphemeralCommandSessionPort,
{
    ...
    let mut dirs = EphemeralDirAllocator::new(context.writable_root)
        ...
        .map_err(|err| {
            WorkspaceApiError::new("ephemeral_command_prepare_failed", err.to_string())
        })?;
    ...
    let run_request = json!({
        ...
        "layer_paths": context.snapshot.layer_paths,
