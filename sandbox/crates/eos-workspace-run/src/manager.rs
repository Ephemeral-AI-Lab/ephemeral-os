...
use crate::registry::{EphemeralRun, IsolatedRun, WorkspaceRun, WorkspaceRunRegistry};
...
impl WorkspaceRunManager {
    ...
    fn start_ephemeral(
        ...
        prepare_request: eos_workspace::PrepareCommandRequest,
        root: PathBuf,
        workspace_root: PathBuf,
        scratch_root: PathBuf,
        yield_time_ms: u64,
    ...
    fn spawn_session(
        &self,
        spec: CommandSessionSpec,
        prepared: eos_workspace::PreparedCommandWorkspace,
