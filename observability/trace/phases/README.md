...
| 6 | [Log Export And Trace Correlation](phase-06-log-export-trace-correlation.md) | Explicit Loki log export and Grafana trace-to-logs correlation after traces/metrics are stable | 640 to 1,160 |
...
- [ ] Treat trace events as trace data until the explicit log-export phase. Do
      not add Loki, log exporters, or trace-to-logs correlation to Phase 1
      through Phase 5.
