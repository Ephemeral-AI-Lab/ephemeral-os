...
use layerstack::{require_workspace_binding, CommitOptions, LayerStack, Lease, WorkspaceBinding};
use namespace::protocol::Intent;
use namespace::protocol::{RunMode, RunRequest, RunResult, ToolCall, WorkspaceRoot};
use plugin::ServiceMode;
use serde_json::{json, Value};
use workspace::NsRunnerLauncher;
use workspace::{capture_upperdir, overlay_run_dirs, OverlayDirs, OverlayDirsGuard};
...
pub struct PluginOverlayOutcome {
    ...
    pub changeset: layerstack::ChangesetResult,
    ...
    pub capture_s: f64,
    pub occ_s: f64,
    pub upperdir_stats: workspace::TreeResourceStats,
...
fn run_plugin_overlay_once(
    ...
    let changeset = layerstack::service::publish_capture_with_options(
