...
use crate::command::{CancellationState, CommandId, CommandLifecycleState, CommandProcessStore};
...
mod tests {
    ...
    fn seed_active(
        ...
        service
            ...
            .insert_active(
                reservation,
                active_record(command_id, caller_id, workspace_id, workspace_root, pgid),
            )
