(function () {
  ...
  function renderHome(data) {
    ...
    document.title = "e2e-test Readme Index";
    $("#app").innerHTML = `
      <header>
        <div class="wrap hero">
          <h1>e2e-test module index</h1>
          <p class="lead">Generated from per-module <code>readme.json</code> data under <code>eos-sandbox/crates/e2e-test/tests</code>. The page renders module overview, checklist IDs, and test cases without hand-editing the HTML content.</p>
          <div class="meta-row">
            ...
            <span class="pill">Cargo package: <code>e2e-test</code></span>
          </div>
          <div class="stats">
  ...
  function renderModulePage(moduleData) {
    ...
    document.title = `${moduleData.displayName || moduleData.name} - e2e-test`;
    $("#app").innerHTML = `
      <header>
        <div class="wrap hero">
