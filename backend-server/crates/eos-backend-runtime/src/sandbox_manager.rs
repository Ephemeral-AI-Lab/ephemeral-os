...
//! [`SandboxGateway`] implementation `eos-runtime` is wired against.
//!
...
/// it into `eos-runtime` via `RuntimeServicesBuilder::sandbox_gateway`, and retain
...
/// The provisioner the gateway hands to `eos-runtime`: its `prepare_for_run` is
