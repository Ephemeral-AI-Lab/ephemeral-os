...
const PACKAGE_POLICIES: &[PackagePolicy] = &[
    ...
    PackagePolicy {
        manifest: "crates/sandbox-observability/application/Cargo.toml",
        name: "sandbox-observability-application",
        layer: Layer::Application,
        allowed: &[
            "sandbox-operation-contract",
            "sandbox-operation-catalog",
    ...
    PackagePolicy {
        manifest: "crates/sandbox-observability/primitives/Cargo.toml",
    ...
    PackagePolicy {
        ...
        layer: Layer::Primitive,
        allowed: &["sandbox-observability", "sandbox-runtime-namespace-process"],
    },
    PackagePolicy {
        manifest: "crates/sandbox-runtime/namespace-process/Cargo.toml",
        name: "sandbox-runtime-namespace-process",
        layer: Layer::Primitive,
        allowed: &["sandbox-observability", "sandbox-runtime-overlay"],
    },
    PackagePolicy {
...
const PROOF_TARGETS: &[(&str, &str, &str)] = &[
    ...
    (
        "sandbox-observability-application",
        "application",
        "crates/sandbox-observability/application/tests/application.rs",
    ),
    (
        "sandbox-console",
        "console",
...
fn validate_catalog_edge(
    ...
    let expected: Option<&[&str]> = match package.name.as_str() {
        ...
        "sandbox-observability-application" => Some(&["observability"]),
