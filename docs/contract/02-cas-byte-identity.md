...
> **Historical contract:** this document is preserved as Python-era migration
> evidence. Live Rust contracts are owned by `crates/protocol`,
> `crates/layerstack`, and the checked fixtures under `contract/fixtures/`.
...
`eos-sandbox/crates/eos-protocol/fixtures/cas/cases.json` (18 cases). The exact
generator is reproduced at the end of this doc and at
`eos-sandbox/docs/contract/_gen_cas_fixtures.py`.
...
- `backend/src/eos-sandbox/layer_stack/manifest.py`
- `backend/src/eos-sandbox/layer_stack/changes.py`
- `backend/src/eos-sandbox/layer_stack/publisher.py`
...
File: `eos-sandbox/crates/eos-protocol/fixtures/cas/cases.json` — JSON array of 18
cases. Each case:
...
uv run python ../eos-sandbox/docs/contract/_gen_cas_fixtures.py
```

The full generator is at `eos-sandbox/docs/contract/_gen_cas_fixtures.py`. It imports
