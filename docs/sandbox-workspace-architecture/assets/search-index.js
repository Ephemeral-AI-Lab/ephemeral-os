window.SANDBOX_WORKSPACE_DOC_SEARCH = [
  ...
  {'id': 'daemon', 'title': '6. Daemon and Background Tasks', 'href': 'daemon.html', 'text': 'Resident daemon control plane, wiki graph, startup transport, TCP and AF_UNIX thin client, request lifecycle, envelope fields, operation table, workspace routing, workflow traces, caches, background heartbeats, cancellation, TTL, isolated gating, diagnostics, and wiki maintenance notes.'},
