...
- Planner and replanner submissions carry structured task JSON only. They do not author free-text outcome summaries or file notes; `parent_summarizer` later submits the outcome roll-up.
