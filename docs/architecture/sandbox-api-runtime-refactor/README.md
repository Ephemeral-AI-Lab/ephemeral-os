...
| 4 | 3 | [Runtime scaffolding](./step-04-slice-3-runtime-scaffolding.md) | `daemon/` → `runtime/`; add `bundle.py`, `setup_orchestrator.py`, `server.py`, peer setup-script contract. |
