export const DESCRIPTION = `Submit the final outcome of this worker run. Terminal: a successful call ends the run.
...
- Never claim more than was done: a faithful partial result beats an inflated complete one.
`;
