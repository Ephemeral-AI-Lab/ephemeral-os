 ...
 * the workflow root; a leading `workflow_<id>` segment is accepted and
 ...
 * live attempt path discovers `archived/`.
 */
...
function normalize(context: WorkflowContext, rawPath: string | undefined): string {
