...
impl ToolExecutor for SubmitRootOutcome {
    async fn execute(
        ...
        request_store.finish_request(request_id, request_status).await?;
...
pub(crate) fn register(registry: &mut crate::ToolRegistry, config: &crate::registry::ToolConfigSet, root: crate::tools::RootSubmissionHandle, attempt: crate::tools::AttemptSubmissionHandle) {
