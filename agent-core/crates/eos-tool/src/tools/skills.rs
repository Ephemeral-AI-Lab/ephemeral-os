...
pub(crate) fn register(registry: &mut crate::ToolRegistry, config: &crate::registry::ToolConfigSet, caller: &crate::tools::CallerScope, skills: crate::tools::SkillHandle) {
