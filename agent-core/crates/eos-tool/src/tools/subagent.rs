...
pub(crate) fn register(registry: &mut crate::ToolRegistry, config: &crate::registry::ToolConfigSet, caller: &crate::tools::CallerScope, launcher: std::sync::Arc<dyn eos_types::AgentRunApi>, background: crate::tools::BackgroundHandle) {
