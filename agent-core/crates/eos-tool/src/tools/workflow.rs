...
pub(crate) fn register(registry: &mut crate::ToolRegistry, config: &crate::registry::ToolConfigSet, workflow: std::sync::Arc<dyn eos_types::WorkflowApi>, background: crate::tools::BackgroundHandle) {
