...
def test_sandbox_api_context_preparer_uses_registered_adapter(
    ...
    from sandbox.api import _provider_control
    ...
    monkeypatch.setattr(
        _provider_control, "get_adapter", lambda _sandbox_id: Adapter()
    )
...
def test_sandbox_api_context_preparer_requires_provider_hook(
    ...
    monkeypatch.setattr(
        _provider_control, "get_adapter", lambda _sandbox_id: object()
    )
