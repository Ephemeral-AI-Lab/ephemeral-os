...
def test_bundle_layout_includes_required_paths(tmp_path: Path) -> None:
    ...
    required = [
        ...
        "sandbox/runtime/handlers/__init__.py",
        "sandbox/runtime/handlers/_common.py",
        "sandbox/runtime/handlers/edit_handler.py",
        "sandbox/runtime/handlers/metrics_handler.py",
