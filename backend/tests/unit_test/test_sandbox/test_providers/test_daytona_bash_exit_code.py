...
from sandbox.provider.daytona import bash as bash_mod
from sandbox.provider.daytona.bash import EXIT_MARKER, extract_exit_code
...
class TestExtractExitCodeFailsClosed:
    ...
    def test_warning_emitted_once_per_session(self, caplog):
        ...
        _reset_warn_flag()
        caplog.set_level(logging.WARNING, logger="sandbox.provider.daytona.bash")
