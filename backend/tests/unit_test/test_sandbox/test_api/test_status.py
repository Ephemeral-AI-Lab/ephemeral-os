...
def test_create_registers_per_id_adapter_and_runs_setup(
    ...
    from sandbox.api import _provider_control_plane as sb_lifecycle
...
def test_read_helpers_route_through_registry(monkeypatch: pytest.MonkeyPatch) -> None:
    from sandbox.api import _provider_control_plane as sb_discovery
    from sandbox.api import _provider_control_plane as sb_preview_urls
