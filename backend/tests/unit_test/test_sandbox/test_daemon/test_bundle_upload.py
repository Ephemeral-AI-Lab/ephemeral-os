...
def test_bundle_layout_includes_required_paths(tmp_path: Path) -> None:
    ...
    required = [
        "sandbox/__init__.py",
        "sandbox/_shared/async_bridge.py",
        ...
        "sandbox/main_workspace/workspace_binding.py",
        ...
        "sandbox/ephemeral_workspace/_manager.py",
        "sandbox/ephemeral_workspace/_operation.py",
        "sandbox/ephemeral_workspace/_publishing.py",
        ...
        "sandbox/ephemeral_workspace/transient.py",
        "sandbox/_shared/env_policy.py",
        "sandbox/_shared/resource_audit.py",
        "sandbox/overlay/__init__.py",
        "sandbox/overlay/capability.py",
        "sandbox/overlay/namespace.py",
        "sandbox/overlay/namespace_child.py",
        ...
        "sandbox/occ/layer_stack_client.py",
