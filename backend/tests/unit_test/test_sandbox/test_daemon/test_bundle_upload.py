...
def test_bundle_layout_includes_required_paths(tmp_path: Path) -> None:
    ...
    required = [
        ...
        "sandbox/execution/contract/request.py",
        "sandbox/execution/contract/result.py",
        "sandbox/execution/contract/ports.py",
        "sandbox/execution/contract/spec.py",
        "sandbox/execution/strategies/__init__.py",
        ...
        "sandbox/execution/overlay/worker.py",
        "sandbox/execution/overlay/change.py",
        "sandbox/execution/overlay/capture.py",
        "sandbox/execution/overlay/result.py",
        "sandbox/execution/overlay/request.py",
        "sandbox/execution/overlay/mounts.py",
        "sandbox/execution/overlay/pipeline.py",
        "sandbox/execution/overlay/runner.py",
