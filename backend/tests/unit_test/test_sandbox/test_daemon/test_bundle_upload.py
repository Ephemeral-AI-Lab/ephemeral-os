...
def test_bundle_layout_includes_required_paths(tmp_path: Path) -> None:
    ...
    required = [
        ...
        "sandbox/execution/service.py",
        "sandbox/execution/runner.py",
        ...
        "sandbox/execution/strategies/namespace.py",
        "sandbox/execution/strategies/namespace_child.py",
        "sandbox/layer_stack/workspace_base.py",
        "sandbox/execution/path_change.py",
        "sandbox/execution/overlay/__init__.py",
        "sandbox/execution/overlay/capture.py",
        "sandbox/execution/overlay/change_synthesis.py",
        "sandbox/execution/overlay/kernel_mount.py",
        "sandbox/execution/overlay/layout.py",
