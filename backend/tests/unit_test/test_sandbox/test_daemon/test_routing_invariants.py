...
def test_daemon_op_table_routes_to_current_handler_layout() -> None:
    ...
    expected = {
        ...
        "api.isolated_workspace.enter": server._iws_enter,
        "api.isolated_workspace.exit": server._iws_exit,
        "api.isolated_workspace.status": server._iws_status,
        "api.isolated_workspace.list_open": server._iws_list_open,
        "api.isolated_workspace.test_reset": server._iws_test_reset,
    }
