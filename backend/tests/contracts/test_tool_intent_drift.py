...
_TOOL_MODULES = (
    ...
    "tools.submission.reducer.submit_reduction_success.submit_reduction_success",
    "tools.submission.reducer.submit_reduction_failure.submit_reduction_failure",
    ...
    "tools.submission.executor.submit_workflow_handoff.submit_workflow_handoff",
    "tools.submission.executor.submit_generator_failure.submit_generator_failure",
    "tools.submission.executor.submit_generator_success.submit_generator_success",
