...
def make_terminal_call_reminder() -> NotificationRule:
    ...
    Fires every turn after the first assistant message while
    ``terminal_result`` is None. No tier gating, no dedup state — the
    reminder repeats until the agent complies or the hard ceiling kills
    the run.
    """
