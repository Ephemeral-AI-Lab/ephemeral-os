"""Episode lifecycle — manager, registry, and re-exported state DTOs.
...
registry. Episode DTOs/enums live in :mod:`task_center.episode.state` and
are re-exported here so ``from task_center.episode import Episode`` works.
"""
