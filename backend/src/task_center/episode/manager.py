"""EpisodeManager — per-episode retry and closure-report emitter.

Sole creator of Attempt attempt records inside its owned episode, and the only
emitter of ``EpisodeClosureReport``.
"""
