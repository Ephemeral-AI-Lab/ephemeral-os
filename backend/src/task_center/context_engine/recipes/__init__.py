...
package that exposes a module-level ``<NAME>_RECIPE`` attribute referencing a
:class:`ContextRecipe`. :func:`register_builtin_recipes` walks every submodule
once at startup and registers every ``*_RECIPE`` it finds.
"""
