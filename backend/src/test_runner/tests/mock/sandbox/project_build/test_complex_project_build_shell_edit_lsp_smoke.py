"""Smoke live regression for the mixed shell-edit + LSP project-build scenario."""
...
from task_center_runner.tests.mock._project_build_contracts import (
    assert_shell_edit_lsp_smoke_contract,
)
...
async def test_complex_project_build_shell_edit_lsp_smoke(
    ...
    await assert_shell_edit_lsp_smoke_contract(
        report=report,
        sandbox_id=sandbox_id,
    )
