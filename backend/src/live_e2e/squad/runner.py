...
from live_e2e.hooks.registry import MutableMockState
from live_e2e.squad.prompt_inspector import (
    LaunchRecord,
    PromptInspection,
    ToolCallRecord,
)
from live_e2e.squad.sandbox_probe import SandboxCheck
from live_e2e.squad.full_stack_tool_scripts import (
...
class MockSquadRunner:
    ...
    def __init__(
        ...
        *,
        ...
        # live_e2e.scenarios re-exports CorrectnessTesting, and importing it
