...
- A new private shim, re-export bridge, module move, or root package file is not an adjacent owner just because a test import names it. Continue only when production code already owns that destination or the task scope names it.
