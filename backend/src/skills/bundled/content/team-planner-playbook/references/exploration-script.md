...
- Example: benchmark failures mention `pkg/io/tests/test_hdf.py`, `pkg/io/tests/test_parquet.py`, `pkg/tests/test_groupby.py`, `pkg/tests/test_cli.py`, `pkg/tests/test_config.py`, and `pkg/tests/test_compat.py`.
  Start with `ci_workspace_structure(path="pkg/io")`, then `ci_scoped_status(scope_paths=["pkg/io/hdf.py"])`, then `load_skill_reference("team-planner-playbook", "scout-launch-contract")`, then scout `pkg/io/hdf.py`, `pkg/io/parquet/`, `pkg/groupby.py`, `pkg/cli.py`, `pkg/config.py`, and `pkg/compat.py`.
