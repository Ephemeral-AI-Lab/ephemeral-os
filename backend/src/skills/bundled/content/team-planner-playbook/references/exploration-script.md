...
4. Must launch scouts only after that live anchor exists.
5. Must keep each scout on one distinct unresolved owner slice.
6. Must stop exploring once the current plan layer can name ready work plus residual boundaries.
