...
1. Use repo-relative production `scope_paths` for every task, including validators; never submit `/testbed/...` paths or sandbox-absolute paths.
  ...
  new_tasks: [
    {
      ...
      description: "Repair replan dependency rewiring",
      name: "developer",
...
submit_plan({
  new_tasks: [
    {
      id: "dev-sandbox-path",
      description: "Repair sandbox-path owner",
      name: "developer",
