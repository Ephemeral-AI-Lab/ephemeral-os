...
Use `ci_query_symbol(..., references=true)(symbol)` on symbols that appear as imports in multiple scout notes to confirm cross-slice usage before finalising the DAG.
