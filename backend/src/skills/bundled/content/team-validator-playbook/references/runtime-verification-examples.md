...
- Must run the exact payload command through `shell("...")` inside `daytona_codeact`, print or persist that same run's exit code and relevant output, and return PASS immediately when it exits `0`.
