...
Iteration DTOs/enums live in :mod:`workflow._core.state`; lifecycle
coordination lives in :mod:`workflow.iteration.attempt_coordinator`.
...
if TYPE_CHECKING:
    from workflow.iteration.attempt_coordinator import (
...
_COORDINATORS = "workflow.iteration.attempt_coordinator"
...
def __getattr__(name: str) -> object:
    try:
        ...
        raise AttributeError(f"module 'workflow.iteration' has no attribute {name!r}") from exc
    import importlib
