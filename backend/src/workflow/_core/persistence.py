...
class TaskStoreProtocol(Protocol):
    """Narrow contract for the request/task persistence surface."""
    ...
    def get_request(self, request_id: str) -> TaskRow | None: ...

    def set_root_task_id(self, request_id: str, root_task_id: str) -> TaskRow: ...

    def finish_request(self, request_id: str, status: str) -> TaskRow | None: ...
