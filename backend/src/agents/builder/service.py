...
class AgentBuilderService:
    ...
    def _record_payload_from_request(data: AgentDefinitionCreate) -> dict[str, object]:
        return {
            ...
            "posthook": getattr(data, "posthook", None) or [],
            "blocked_tools": getattr(data, "blocked_tools", None) or [],
            "allowed_triggers": getattr(data, "allowed_triggers", None) or [],
            "hooks": data.hooks,
