...
description: Main agent planner for TaskCenter harness graphs (default variant — can close or defer the goal).
model: inherit
tool_call_limit: 100
agent_kind: planner
agent_type: agent
...
# then `config/skills/planner_closes_or_defers/SKILL.md` reuses the
...
# convention.
skill: ../../../../config/skills/planner_closes_or_defers/SKILL.md
variants:
