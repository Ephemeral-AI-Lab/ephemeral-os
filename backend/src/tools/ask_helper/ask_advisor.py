...
@tool(
    name="ask_advisor",
    description=(
        "Ask the advisor helper for blocking read-only audit of your "
        "intended terminal submission. The advisor sees the parent's "
        "original context, original task, and a filtered transcript, then "
        "returns approve/reject via submit_advisor_feedback."
    ),
