"""Description factory for submit_advisor_feedback."""

from __future__ import annotations

from tools._names import ASK_ADVISOR_TOOL_NAME


def get_submit_advisor_feedback_description() -> str:
    return f"""\
...
Behavior:
- The verdict + summary is returned to the caller via `{ASK_ADVISOR_TOOL_NAME}`.
