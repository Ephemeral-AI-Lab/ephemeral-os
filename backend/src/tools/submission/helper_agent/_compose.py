...
context_packet_id, derive the request_id, build a :class:`ContextScope`,
...
def compose_helper_bundle(
    *,
    ...
    request_id = context.task_center_request_id
    if not request_id:
        ...
        request_id = parent_packet.canonical_refs.request_id
