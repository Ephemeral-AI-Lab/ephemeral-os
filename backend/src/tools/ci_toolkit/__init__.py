...
_INSTRUCTIONS = (
    ...
    "Use `daytona_rename_symbol(symbol, new_name)` from the sandbox operations toolkit "
    "for semantic cross-file Python renames; it consumes the same code intelligence service "
    "after Daytona runtime context is injected.\n"
