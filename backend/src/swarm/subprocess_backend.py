...
from ephemeralos.swarm.spawn_utils import (
...
class SubprocessBackend:
    ...
    Uses the existing :class:`~ephemeralos.tasks.manager.BackgroundTaskManager`
    ...
    async def spawn(self, config: TeammateSpawnConfig) -> SpawnResult:
        ...
        cmd_parts = [teammate_cmd, "-m", "ephemeralos"] + flags
