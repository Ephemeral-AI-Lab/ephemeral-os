...
from ephemeralos.swarm.spawn_utils import is_tmux_available
from ephemeralos.swarm.types import BackendDetectionResult, BackendType, TeammateExecutor
...
class BackendRegistry:
    ...
    def get_executor(self, backend: BackendType | None = None) -> TeammateExecutor:
        ...
        Returns:
            The registered :class:`~ephemeralos.swarm.types.TeammateExecutor`.
    ...
    def get_preferred_backend(self, config: dict | None = None) -> BackendType:
        ...
        if config:
            ...
            mode = os.environ.get("EPHEMERALOS_TEAMMATE_MODE", "auto")
    ...
    def _register_defaults(self) -> None:
        ...
        from ephemeralos.swarm.in_process import InProcessBackend
