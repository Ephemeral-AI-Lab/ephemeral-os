"""3.6.2 grep/glob stays warm and read-only after many project edits."""
...
from task_center_runner.tests.mock._project_build_contracts import (
    ...
    assert_project_build_grep_glob_low_latency_after_many_edits,
)
...
async def test_project_build_grep_glob_low_latency_after_many_edits(
    sweevo_image_instance: SWEEvoInstance,
    workspace: dict[str, object],
    audit_dir: Path,
    stores: TaskStoreBundle,
) -> None:
    scenario = SCENARIO_REGISTRY["sandbox.complex_project_build_grep_glob"]()
    ...
    await assert_project_build_grep_glob_low_latency_after_many_edits(report)
