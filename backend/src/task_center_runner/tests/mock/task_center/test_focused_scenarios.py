...
_FOCUSED_CASES: tuple[FocusedScenarioCase, ...] = (
    FocusedScenarioCase(
        ...
        min_done_role_tasks={"executor": 1, "evaluator": 1},
        attempt_count=1,
    ),
    FocusedScenarioCase(
        "pipeline.iterative_deferral",
        min_done_role_tasks={"planner": 1, "executor": 2, "evaluator": 2},
    ...
    FocusedScenarioCase(
        ...
        min_done_role_tasks={"planner": 2, "executor": 2, "evaluator": 1},
        min_failed_role_tasks={"evaluator": 1},
        attempt_count=2,
    ),
    FocusedScenarioCase(
        ...
        min_done_role_tasks={"planner": 1, "executor": 1, "evaluator": 1},
        attempt_count=2,
    ),
    FocusedScenarioCase(
        "pipeline.attempt_retry_generator_failure",
        min_done_role_tasks={"planner": 2, "executor": 1, "evaluator": 1},
    ...
    FocusedScenarioCase(
        ...
        min_role_tasks={"executor": 7},
        min_done_role_tasks={"planner": 2, "executor": 6, "evaluator": 1},
        min_failed_role_tasks={"executor": 1},
        attempt_count=2,
    ),
    FocusedScenarioCase(
    ...
    FocusedScenarioCase(
        ...
        absent_role_tasks=("executor", "evaluator"),
        workflow_status="failed",
        attempt_count=2,
    ),
    FocusedScenarioCase(
