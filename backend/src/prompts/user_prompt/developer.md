...
6. Submit `submit_task_summary(type="success", summary=...)` when complete. Submit `submit_task_summary(type="fail", summary=...)` if you hit a blocker, need more investigation, or cannot resolve the task.
