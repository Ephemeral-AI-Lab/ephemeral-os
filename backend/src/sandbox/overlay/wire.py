...
def shell_result_from_dict(d: dict[str, Any]) -> ShellResult:
    return ShellResult(
        ...
        ambient_changed_paths=_str_tuple(d.get("ambient_changed_paths")),
        files_written=int(d.get("files_written") or 0),
        git_commit_status=d.get("git_commit_status"),
        git_conflict_file=d.get("git_conflict_file"),
        git_conflict_reason=d.get("git_conflict_reason"),
        gitinclude_changed_paths=_str_tuple(d.get("gitinclude_changed_paths")),
        gitignore_changed_paths=_str_tuple(d.get("gitignore_changed_paths")),
        gitignore_direct_merged_paths=_str_tuple(d.get("gitignore_direct_merged_paths")),
        gitignore_direct_merged_count=int(d.get("gitignore_direct_merged_count") or 0),
        mixed_gitinclude_gitignore=bool(d.get("mixed_gitinclude_gitignore", False)),
        mixed_partial_apply=bool(d.get("mixed_partial_apply", False)),
