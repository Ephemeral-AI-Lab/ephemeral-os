...
class EvalResult:
    ...
    def text(self) -> str:
        ...
        from engine.messages import TextBlock
    ...
    def thinking_text(self) -> str:
        ...
        return "".join(
            e.text for e in self.events if isinstance(e, ThinkingDelta)
        )
...
class EvalAgent:
    ...
    Wraps QueryEngine with credentials from settings.json. Test classes
